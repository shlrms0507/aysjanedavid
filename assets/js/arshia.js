...
document.querySelector(".portfolio-box").addEventListener("click", function () {
  window.location.href =
    "https://drive.google.com/drive/folders/1ZmEkc9sf7elOLdAVeKjNLanxYNBHvNrg?usp=sharing";
});
